...
contract RAIToken is ERC20Token {
    ...
    address public feeReceiver = 0xF43E56C449Fbf303F0cD15Ec6133ccC4cdeF678f;
    string private nameToken ="RAI";
    string private symbolToken="RAI";

    uint256 public constant PRECISION = 100e3;

    uint256 public sellFeeRatio = 20e3;
    ...
    constructor() ERC20Token(nameToken,symbolToken) {
        _name=nameToken;
        _symbol=symbolToken;
        _decimals = 18;
        _setupRole(MINT,msg.sender);
        _setupRole(COOLING_PROTECTOR,msg.sender);
